...
class CXRDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if os.path.isfile(os.path.join(self.path_to_images, self.df.index[idx])):
            image = Image.open(os.path.join(self.path_to_images, self.df.index[idx]))
        elif os.path.isfile(os.path.join(self.path_to_images, self.df.index[idx].replace(".png",".jpg"))):
            image = Image.open(os.path.join(self.path_to_images, self.df.index[idx].replace(".png",".jpg")))
        else:
